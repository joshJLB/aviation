  ...
  function get_widget_form() {
    ...
    return array(
      // put all fields here
        'title' => array(
          'type' => 'text',
          'label' => __('Contact Page Title', 'widget-form-fields-text-domain')
        ),
        
        'phone_text' => array(
          'type' => 'text',
          'label' => __('Phone Contact Text', 'widget-form-fields-text-domain')
        ),
        'location_text' => array(
          'type' => 'text',
          'label' => __('Location Contact Text', 'widget-form-fields-text-domain')
        ),
        'email_text' => array(
          'type' => 'text',
          'label' => __('Email Contact Text', 'widget-form-fields-text-domain')
        ),
    );
  }
}
